      ...
      <div>
        ...
        <div className='developer' ref={developerRef}>
                ...
                <div className='carousel-container'>
                    ...
                    >
                        <div>
                            <img src={`${process.env.PUBLIC_URL}/Landing-page.png`} alt="Slide 1" />
                            <a href="https://66a66b2c02b89e51ad008d4d--inquisitive-hotteok-4df95e.netlify.app/">
                                <p className="legend">Edutech</p>
                            </a>
                        </div>
                        <div>
                            <img src={`${process.env.PUBLIC_URL}/Screenshot_11-8-2024_62716_localhost.jpeg`} alt="Slide 2" />
                            <a href="https://github.com/adviti1/Admin-User-backend">
                                <p className="legend">Admin-User based backend</p>
                            </a>
                        </div>
                        <div>
                            <img src={`${process.env.PUBLIC_URL}/Screenshot_11-8-2024_6311_localhost.jpeg`} alt="Slide 3" />
